...
jQuery(function ($) {
    ...
    $('#wpbody').on('change', '.wp-team-matches-widget-settings .widget-setting-hide-older-than select', function () {
        var $container = $(this).closest('.wp-team-matches-widget-settings');
