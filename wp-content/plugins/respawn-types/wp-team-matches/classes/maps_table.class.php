...
add_filter('set-screen-option', array('\WP_TeamMatches\MapsTable', 'handle_screen_option'), 10, 3);

class MapsTable extends \WP_List_Table {

    const PER_PAGE_OPTION = 'wp_team-matches_maps_per_page';
    ...
    function get_table_classes() {
        ...
        $classes[] = 'wp-team-matches-maps-table';
        return $classes;
    }
    ...
    protected function handle_row_actions( $item, $column_name, $primary ) {
        ...
        $edit_link = admin_url('admin.php?page=wp-team-matches-games&amp;act=editmap&amp;id=' . $item->id);
        $delete_link = wp_nonce_url('admin-post.php?action=wp-team-matches-deletemaps&amp;do_action=delete&amp;delete[]=' . $item->id . '&amp;_wp_http_referer=' . urlencode($_SERVER['REQUEST_URI']), 'wp-team-matches-deletemaps');
    ...
    function prepare_items() {
        ...
        $maps = \WP_TeamMatches\Maps::get_map( $args );
