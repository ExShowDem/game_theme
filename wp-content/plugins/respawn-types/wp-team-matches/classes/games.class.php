...
";
    ...
    static function get_game($options) {
        ...
        extract( \WP_TeamMatches\Utils::extract_args($options, $defaults) );
...
SQL;
        ...
        return \WP_TeamMatches\DB::get_results( $query );
    }
    ...
    static function add_game($options) {
        ...
        $data = \WP_TeamMatches\Utils::extract_args($options, $defaults);
    ...
    static function delete_game($id) {
        ...
        \WP_TeamMatches\Maps::delete_map_by_game($id);
        \WP_TeamMatches\Matches::delete_match_by_game($id);
