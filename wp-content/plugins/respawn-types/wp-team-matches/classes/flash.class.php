...
class Flash {
    ...
    const FLASH_USER_META_KEY = "_wp-team-matches_flash_messages";
    ...
    static function setup() {
        ...
        add_action('admin_notices', '\\WP_TeamMatches\\Flash::_print_admin_notices');
        register_shutdown_function( '\\WP_TeamMatches\\Flash::_shutdown' );
    }
