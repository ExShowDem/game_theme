...
class DB {
    ...
    /**
     * Runs wpdb->get_results() and converts the result into \WP_TeamMatches\DBResult object.
     * @param  string $query
     * @param  string $output_type
     * @see wpdb::get_results()
     * @return \WP_TeamMatches\DBResult
     */
     ...
     * Use this method after running a query with SQL_CALC_FOUND_ROWS.
     * @return \WP_TeamMatches\Pagination
     */
    private static function _get_pagination() {
        ...
        return new \WP_TeamMatches\Pagination( $found_rows, $limit );
    }
