...
class Utils {
    ...
    static function html_date_helper( $prefix, $time = 0, $tab_index = 0, $select_class = '' )
    {
        ...
        if($time == 0) {
            $time_adj = \WP_TeamMatches\Utils::current_time_fixed('timestamp', 0);
        }
        else {
            $time_adj = $time;
        }
    ...
    static function html_country_select_helper($p = array(), $print = true)
    {
        ...
        extract(\WP_TeamMatches\Utils::extract_args($p, array(
            'select' => '',
            'name' => '',
            'id' => '',
            'class' => '',
        ...
        /*
        if($show_popular) {
            $popular = \WP_TeamMatches\Teams::most_popular_countries();
