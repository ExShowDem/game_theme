...
class WP_TeamMatches_List_Widget extends WP_Widget {
    ...
    function __construct()
    {
        ...
        $widget_ops = array(
            'classname' => 'widget_team-matches bmatchlist block-wrap ' . $theme_class,
            'description' => esc_html__('TeamMatches list widget', WP_CLANWARS_TEXTDOMAIN)
        );
        parent::__construct('team-matches-list', esc_html__('TeamMatches List', WP_CLANWARS_TEXTDOMAIN), $widget_ops);

        $this->default_settings = array(
            'title' => esc_html__('Team Matches List', WP_CLANWARS_TEXTDOMAIN),
