...
class WP_TeamMatches_Widget extends WP_Widget {
    ...
    function __construct()
    {
        ...
        $widget_ops = array(
            ...
            'description' => __('TeamMatches widget', WP_CLANWARS_TEXTDOMAIN)
        );
        parent::__construct('team-matches', __('TeamMatches', WP_CLANWARS_TEXTDOMAIN), $widget_ops);

        $this->default_settings = array(
            'title' => __('Team Matches', WP_CLANWARS_TEXTDOMAIN),
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('TeamMatches', WP_CLANWARS_TEXTDOMAIN) : $instance['title']);
        ...
        $_games = \WP_TeamMatches\Games::get_game($options);
        ...
        foreach($_games as $game) {
            ...
            $matchResult = \WP_TeamMatches\Matches::get_match( $options );
...
<ul class="teamwar-list<?php if($instance['display_game_icon']) echo ' shows-game-icon'; ?>">
    ...
    <?php foreach($matches as $i => $match) :
            ...
            $item_classes = [ 'teamwar-item', 'game-' . $match->game_id ];
    ...
    <li class="<?php echo esc_attr( join(' ', $item_classes) ); ?>">
            ...
            <?php
                $team1_flag = \WP_TeamMatches\Utils::get_country_flag($match->team1_country);
                $team2_flag = \WP_TeamMatches\Utils::get_country_flag($match->team2_country);
