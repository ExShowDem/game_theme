=== WP-TeamMatches ===
Contributors: andddd
Tags: cybersport, teamwar, team, team, cyber, sport, match, gaming, game, community
...
WP-TeamMatches is a match organizer plugin for gaming communities and teams.

== Help out to translate this plugin ==

Wanna see WP-TeamMatches in your language? Help out to translate it!

[https://www.transifex.com/projects/p/wp-team-matches/](https://www.transifex.com/projects/p/wp-team-matches/)

== Description ==

WP-TeamMatches is a match organizer plugin for gaming communities and teams. It supports multiple games, sidebar widget, match browser, and allows multigamings to delegate match scheduling between multiple war arrangers using simple access control system.
...
* Fix error in database handling routine ([issue #3](https://github.com/pronebird/wp-team-matches/issues/3))
