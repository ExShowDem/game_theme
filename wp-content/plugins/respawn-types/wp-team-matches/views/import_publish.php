<div class="wrap wp-team-matches-cloud-page">
    ...
    <p class="wp-team-matches-install-help"><?php _e('You can share created games with others.', WP_CLANWARS_TEXTDOMAIN); ?></p>

<?php if($logged_into_cloud) : ?>

    <p class="wp-team-matches-install-help small"><?php _e('Upload may take some time. Please do not refresh browser when in progress.', WP_CLANWARS_TEXTDOMAIN); ?></p>

    <form method="post" action="<?php echo admin_url( 'admin-post.php' ); ?>" enctype="multipart/form-data" class="wp-team-matches-publish-form">
...
<p class="wp-team-matches-install-help small"><?php _e('Please log in first.', WP_CLANWARS_TEXTDOMAIN); ?></p>
