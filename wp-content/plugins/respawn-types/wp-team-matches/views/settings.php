<div class="wrap wp-team-matches-settings">

    <h2><?php _e('Settings', WP_CLANWARS_TEXTDOMAIN); ?></h2>

    <!-- Basic Settings -->
    <form method="post" action="<?php echo admin_url('admin-post.php'); ?>">
        <?php wp_nonce_field('wp-team-matches-settings'); ?>
        <input type="hidden" name="action" value="wp-team-matches-settings" />
    ...
    <div id="col-container">
        ...
        <div id="col-right">
            ...
            <form method="post" action="<?php echo admin_url('admin-post.php'); ?>">
                <?php wp_nonce_field('wp-team-matches-deleteacl'); ?>
                <input type="hidden" name="action" value="wp-team-matches-deleteacl" />
                ...
                <table class="wp-team-matches-acl-table widefat striped" cellspacing="0">
                    <thead>
                        <tr>
        ...
        <div id="col-left">
            ...
            <form class="form-wrap" method="post" action="<?php echo admin_url('admin-post.php'); ?>">
                <?php wp_nonce_field('wp-team-matches-acl'); ?>
                <input type="hidden" name="action" value="wp-team-matches-acl" />
