<div class="wrap wp-team-matches-onboarding-page setup-games">

    <h1><?php _e( 'Get started with WP-TeamMatches', WP_CLANWARS_TEXTDOMAIN ); ?></h1>
    ...
    <div class="left-column">
        ...
        <form action="<?php echo admin_url('admin-post.php'); ?>" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="action" value="wp-team-matches-setupgames" />

            <?php wp_nonce_field('wp-team-matches-setupgames'); ?>
    ...
    <div class="right-column">
        ...
        <li class="wp-team-matches-cloud-item">
