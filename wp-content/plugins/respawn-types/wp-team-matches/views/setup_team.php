<div class="wrap wp-team-matches-onboarding-page setup-team">
    ...
    <form action="<?php echo admin_url('admin-post.php'); ?>" method="post">
        ...
        <input type="hidden" name="action" value="wp-team-matches-setupteam" />

        <?php wp_nonce_field('wp-team-matches-setupteam'); ?>
