 ...
 */
{
    ...
    class Slide {
        constructor(el) {
            ...
            let slide;
            this.DOM.imgWrap = slide = this.DOM.el.querySelector('.slide__img-wrap');
            this.DOM.slideTrans =  slide.parentElement;
        ...
        setLeft(hideBefore = true) {
            ...
            this.DOM.el.classList.add('slide--left', 'slide--visible', 'slide_trans');
        }
        // Set the class right.
        setRight(hideBefore = true) {
            ...
            this.DOM.el.classList.add('slide--right', 'slide--visible', 'slide_trans');
        }
        // Show the revealer and reset the texts that are visible for the left and right slides.
        resetLeftRight() {
            this.showRevealer({animation: false});
    ...
    class Slideshow {
        ...
        initEvents() {
            ...
            for (let slide of this.slides) {
                slide.DOM.slideTrans.addEventListener('click', () => this.navigateFn(slide));
            }
        }
