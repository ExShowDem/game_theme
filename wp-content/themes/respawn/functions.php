...
function respawn_scripts() {
    ...
    $header_position = '';
    if(isset($options['header-position']))
        $header_position =  $options['header-position'];

    $menuLayout = '';
    if(isset($options['header-settings-layout-menu']))
        $menuLayout =  $options['header-settings-layout-menu'];

    $onePage = '';
    if(isset($options['general-settings-one-page']))
        $onePage =  $options['general-settings-one-page'];

    $blog_feed = '';
    if(isset($options['blog-feed-template']))
        $blog_feed =  $options['blog-feed-template'];

    $settingsGlobal = array(
        'fixedMenu' => $header_position,
...
function respawn_body_classes($classes ) {
    ...
    if(isset($options['header-position']) && $options['header-position'] == 'fixed'){ $header_position_class = 'has-fixed-header';}
